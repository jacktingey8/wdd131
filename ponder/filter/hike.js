...
// const people = [  {name: "John", age: 8},{name: "jack", age:19},{name: "jill", age:40}]
...
const filteredhikes= hikes.filter(hike =>{
    ...
    // if (hike.name.toLowerCase().includes(input)){return true}

    // else {return false}

    return (hike.name.toLowerCase().includes(input) || hike.description.toLowerCase().includes(input))
})

console.log(filteredhikes)

filteredhikes.sort(difficultySort);
